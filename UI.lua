...
function lf.SetupUI()
    ...
    g_UI.Tabs:SetTab(c_UI.TabId.Local,  {id = c_UI.TabId.Local,     label = "Local Settings"}) -- Can have texture and region keys if you want an icon on the tab, like Inventory/Account Items, and also a tint key, like Arcporter
    g_UI.Tabs:SetTab(c_UI.TabId.Global, {id = c_UI.TabId.Global,    label = "Global Settings"})
